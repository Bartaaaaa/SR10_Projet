...
module.exports = {
    ...
    create: function (etat, lieuMission, rythme, salaireMin, salaireMax, description,  metier, statutPoste, organisation, callback) {
        ...
        let sql = "INSERT INTO FichePoste (etat, lieuMission, rythme, salaireMin, salaireMax, description, metier, statutPoste, organisation) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        db.query(sql, [etat, lieuMission, rythme, salaireMin, salaireMax, description,  metier, statutPoste, organisation], function (err, results) {
            if (err) {
